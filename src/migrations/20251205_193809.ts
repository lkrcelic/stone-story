...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_products_origin" AS ENUM('italy', 'portugal', 'spain', 'norway', 'sweden', 'finland', 'germany', 'uk', 'france', 'austria', 'malta', 'poland', 'greece', 'slovenia', 'croatia');
  CREATE TYPE "public"."enum_products_type" AS ENUM('marble', 'sandstone', 'travertine', 'limestone', 'granite', 'slate', 'serpentinite');
  ...
  CREATE TYPE "public"."enum__products_v_version_origin" AS ENUM('italy', 'portugal', 'spain', 'norway', 'sweden', 'finland', 'germany', 'uk', 'france', 'austria', 'malta', 'poland', 'greece', 'slovenia', 'croatia');
  CREATE TYPE "public"."enum__products_v_version_type" AS ENUM('marble', 'sandstone', 'travertine', 'limestone', 'granite', 'slate', 'serpentinite');
