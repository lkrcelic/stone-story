...
import { PlusIcon, TrashIcon } from '@/components/ChatBot/icons'
import { getChatHistoryPaginationKey, SidebarHistory } from '@/components/ChatBot/sidebar-history'
...
import type { User } from '@/lib/payload-auth'
